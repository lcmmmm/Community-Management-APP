...
const CommentSection = (props) => {
  ...
  const [comments, setComments] = useState([
    { id: 1, announcementID: 13, name: '劉阿版', img: require("../assets/img/comment.png"), content: "為什麼又要洗水塔，又要停水很麻煩欸！", time: '13 小時前'},    
    { id: 2, announcementID: 3, name: '小黃雞', img: require("../assets/img/image12.png"), content: "看起來真好玩", time: '2024-03-26'},    
    { id: 3, announcementID: 13, name: '管理員', img: require("../assets/img/image27.png"), content: "不好意思，因為近日有颱風造成水質下降，因此管委會決定要再次清洗水塔，對於您的不便，我們深感抱歉。", time: '2 小時前'}
