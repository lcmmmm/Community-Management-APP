...
const CommentSection_Admin = (props) => {
  const { aID } = props;
  ...
  const handleAddComment = () => {
    if (inputText.trim() !== '') {
      setComments([...comments, { id: comments.length + 1, content: inputText, name: '管理員', time: '剛剛', announcementID: aID, img: require("../assets/img/image27.png") }]);
      setInputText('');
    }
  };
